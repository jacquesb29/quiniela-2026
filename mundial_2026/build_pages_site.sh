...
payload = {
    ...
    "deep_bracket_minimum_iterations": 15000,
    "full_100k_bracket_refresh_interval_minutes": 1440,
    "full_100k_bracket_workflow": "quiniela-100k.yml",
    "full_100k_bracket_update_policy": "La llave 100k no corre cada 5 minutos: se publica de madrugada, se puede lanzar manualmente despues de cambios grandes, tambien corre tras push relevante de modelo/datos, y el tablero live de 5 minutos sigue usando la ultima llave profunda publicada.",
    "update_policy_summary": "Marcadores, picks y lectura in-play: cada 5 minutos. Llave profunda minima 15k: cada 60 minutos. Llave completa 100k: diaria/manual/push relevante por costo de computo.",
