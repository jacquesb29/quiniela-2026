    ...
    def test_run_quiniela_audit_passes_with_minimal_valid_generated_artifacts(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            dashboard_path.write_text(
                ...
                "<p>Exactos realistas</p><p>Llave dinámica</p>"
                ...
                "<p>Marcadores para cargar en Penca</p><p>marcador optimizado por ensamble</p>"
                "<p>Ensamble no solo Poisson</p><p>Boleto completo</p>"
                ...
                "<p>Firmeza de picks base</p><p>Firmeza con estrategia aplicada</p>"
                "<p>Firmeza si fuerzas pick único</p>"
