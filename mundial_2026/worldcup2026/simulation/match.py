...
def build_simulation_context(
    ...
    *,
    ...
    return MatchContext(
        ...
        heat_humidity_load=weather_bucket,
        time_zone_shift_a=float(getattr(teams[team_a], "time_zone_shift", 0.0) or 0.0),
        time_zone_shift_b=float(getattr(teams[team_b], "time_zone_shift", 0.0) or 0.0),
        venue_surface_adjustment_a=float(getattr(teams[team_a], "venue_surface_adjustment", 0.0) or 0.0),
        venue_surface_adjustment_b=float(getattr(teams[team_b], "venue_surface_adjustment", 0.0) or 0.0),
        travel_cluster_difficulty_a=float(getattr(teams[team_a], "travel_cluster_difficulty", 0.0) or 0.0),
        travel_cluster_difficulty_b=float(getattr(teams[team_b], "travel_cluster_difficulty", 0.0) or 0.0),
