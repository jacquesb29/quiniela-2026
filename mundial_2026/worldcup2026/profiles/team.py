...
def profile_for(
    ...
    *,
    ...
    population_index_fn,
    gdp_index_fn,
    league_strength_index_fn,
    macro_resource_index_fn,
    heritage_index_fn,
    world_cup_titles,
    trajectory_index_fn,
    coach_index_fn,
    ...
    return TeamProfileCls(
        ...
        population_index=population_index_fn(team),
        gdp_index=gdp_index_fn(team),
        league_strength_index=league_strength_index_fn(team),
        macro_resource_index=macro_resource_index_fn(team),
        ...
        geography_2026_index=geography_2026_index_fn(team),
